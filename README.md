...
||[own_functions.py](https://github.com/IliaShi/souz_mulfilm/blob/main/code/own_functions.py) | Модуль с собственными функциями для обзора и подготовки данных |
|| [demonstration.ipynb](https://github.com/IliaShi/souz_mulfilm/blob/main/code/demonstration.ipynb) | Тетрадка, демонтрирующая работу модуля reels_clf.py |
