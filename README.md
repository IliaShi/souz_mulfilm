...
Базовое решение: классификация с помощью RandomForest тектового описания из поля 'text', векторизованного методом tf-idf. Метрика качества на тестовых данных: f1 = 0.65.
